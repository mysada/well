            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="d-flex">
                        ...
                        <button type="submit" class="btn-product btn-dark w-100 h-50">Wishlist <i class="far fa-heart"></i></button>
                        </form>
                    </div>
                </div>
            </div>
                ...
                @foreach($relatedProducts as $relatedProduct)
                    <div class="related-product-item">
                        <div class="card shadow-sm">
                            <img src="{{ asset($relatedProduct->randomImageUrl) }}" class="card-img-top" alt="{{ $relatedProduct->name }}">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <button class="btn-product btn-add-cart" onclick="window.location.href='{{ route('cartItemPage', $relatedProduct->id) }}'"><i class="fa fa-plus"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
