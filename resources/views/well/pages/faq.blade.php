                    ...
                    <div class="accordion" id="faqAccordion">
                        ...
                        <div class="card mb-3">
                            <div class="card-header bg-light" id="headingTwo">
                                <h5 class="mb-0">
                                    <button class="btn btn-link text-dark font-weight-bold collapsed" type="button"
                            ...
                            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                                 data-bs-parent="#faqAccordion">
                                <div class="card-body">
                                    Yes, we offer international shipping to most countries. Shipping rates and delivery
                        ...
                        <div class="card mb-3">
                            ...
                            <div id="collapseThree" class="collapse" aria-labelledby="headingThree"
                                 data-bs-parent="#faqAccordion">
                                <div class="card-body">
                                    After your order has shipped, you will receive a tracking number via email. You can
                        ...
                        <div class="card mb-3">
                            ...
                            <div id="collapseFour" class="collapse" aria-labelledby="headingFour"
                                 data-bs-parent="#faqAccordion">
                                <div class="card-body">
                                    If you need to modify or cancel your order, please contact our customer service team
                                    as soon as possible. We can make changes or cancel your order if it has not yet been
                                    processed.
                                </div>
                            </div>
                        </div>
                        <div class="card mb-3">
                            ...
                            <div id="collapseFive" class="collapse" aria-labelledby="headingFive"
                                 data-bs-parent="#faqAccordion">
                                <div class="card-body">
                                    Yes, we offer gift cards in various denominations. You can purchase them on our
                                    website or in-store.
                                </div>
                            </div>
                        </div>
                        <div class="card mb-3">
                            ...
                            <div id="collapseSix" class="collapse" aria-labelledby="headingSix"
                                 data-bs-parent="#faqAccordion">
                                <div class="card-body">
                                    We accept various payment methods, including major <strong>Credit Cards, PayPal, and
                                        Apple Pay</strong>. You can choose your preferred payment method at checkout.
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion" id="healthCareAccordion">
                        <div class="card mb-3">
                            ...
                            <div id="collapseSeven" class="collapse show" aria-labelledby="headingSeven"
                                 data-bs-parent="#healthCareAccordion">
                                <div class="card-body">
                                    Our supplements are made from high-quality, natural ingredients. Each product has a
                                    detailed list on the label.
                                </div>
                            </div>
                        </div>
                        <div class="card mb-3">
                        ...
                        <div class="card mb-3">
                            ...
                            <div id="collapseTen" class="collapse" aria-labelledby="headingTen"
                                 data-bs-parent="#healthCareAccordion">
                                <div class="card-body">
                                    Store supplements in a cool, dry place. Follow the storage instructions on the
                                    label.
                                </div>
                            </div>
                        </div>
                        <div class="card mb-3">
                            ...
                            <div id="collapseEleven" class="collapse" aria-labelledby="headingEleven"
                                 data-bs-parent="#healthCareAccordion">
                                <div class="card-body">
                                    Many of our products are designed for sensitive skin. Check product details for
                                    compatibility.
                                </div>
                            </div>
                        </div>
                        <div class="card mb-3">
                            ...
                            <div id="collapseTwelve" class="collapse" aria-labelledby="headingTwelve"
                                 data-bs-parent="#healthCareAccordion">
                                <div class="card-body">
                                    Consult with your healthcare provider before using supplements with prescription
                                    medications.
                                </div>
                            </div>
                        </div>
