...
<div class="thank-you-page">
    <div class="container">
            ...
            <div class="card-body text-center">
                ...
                <div class="order-info mt-4">
                    ...
                    <p><strong>Estimated Delivery Date:</strong>
                        {{ $order->delivery_date ? $order->delivery_date->format('F d, Y') : 'Not Available' }}
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="payment-details card border-custom mb-4 col-md-6">
                ...
                <div class="card-body">
                    ...
                    <p><strong>Shipping Cost:</strong> ${{ number_format($country->shipping_rate, 2) }}</p> <!-- Updated line -->
        ...
        <a href="{{ route('products.index') }}" class="btn btn-custom btn-lg btn-block mt-4">Continue Shopping</a>
    </div>
</div>
@endsection
