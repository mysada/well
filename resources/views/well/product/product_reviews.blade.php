                ...
                <div class="col-md-6">
                    ...
                    <div class="d-flex align-items-center mb-4">
                        <div id="quantity" class="qty-input">
                            ...
                            <input class="product-qty" type="number" name="quantity" min="1" max="{{ $product->stock }}"
            ...
            <div class="row mt-5">
                <div class="col-md-12">
                    ...
                    <div class="overall-rating d-flex align-items-center mb-4">
                        <h3 class="overall-rating-value"
                            style="margin-right:10px">{{ number_format($product->reviews->avg('rating'), 1) }}</h3>
                        <div class="overall-rating-stars">
                            @for ($i = 0; $i < 5; $i++)
                                <svg xmlns="http://www.w3.org/2000/svg"
                                     fill="{{ $i < $product->reviews->avg('rating') ? '#f8ce0b' : '#ccc' }}"
                                ...
                                <div class="review-body">
                                    ...
                                    @if($review->image)
                                        <div class="review-image">
                                            <img src="{{ asset($review->image) }}" alt="Review Image Upload"
                                                 id="review_image">
                                        </div>
                                    @endif
                                </div>
                ...
                @if($hasPurchased)
                    <div id="write-review" class="row mt-5">
                        <div class="col-md-12">
                            ...
                            <form action="{{ route('reviews.store', ['id' => $product->id]) }}" class="review-form"
                                ...
                                <div class="form-group">
                                    ...
                                    @error('rating')
                                    <div id="first-error" class="invalid-feedback">{{ $message }}</div>
                                    <!-- Added ID here -->
                                    @enderror
                                </div>
                                ...
                                <button type="submit" class="btn btn-primary" style="margin-top:10px">Submit Review
                                </button>
                            </form>
                        </div>
                    </div>
