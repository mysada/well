...
<section class="hero-section">
    <img src="{{ asset('/images/home/home_banner.jpg') }}" alt="Hero Image">
...
<section class="category-section text-center">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card category-card" style="background-image: url('{{ asset('/images/home/category_1.jpg') }}');">
            ...
            <div class="col-md-4">
                <div class="card category-card" style="background-image: url('{{ asset('images/home/category_2.jpg') }}');">
            ...
            <div class="col-md-4">
                <div class="card category-card" style="background-image: url('{{ asset('images/home/category_3.jpg') }}');">
        ...
        <div class="row-best-seller d-flex">
            <div class="col-md-6">
                <div class="row-best-seller-left text-center">
                    <div class="card best-seller-card" style="background-image: url('{{ asset('images/home/bs_1.jpg') }}');">
                        <div class="card-body">
            ...
            <div class="col-md-6">
                <div class="row-best-seller-right">
                    <div class="card-right">
                        <div class="best-seller-card-right" style="background-image: url('{{ asset('images/home/bs_2.jpg') }}');">
                        </div>
                        <div class="bs-text">
                    ...
                    <div class="card-right">
                        <div class="best-seller-card-right" style="background-image: url('{{ asset('images/home/bs_3.jpg') }}');">
                        </div>
                        <div class="bs-text">
                            <h5 class="bs-title">Nterdum et malesuada</h5>
                            <p>Nterdum et malesuada fames ac ante ipsum primis in faucibus.</p>
...
<section class="products-section text-center">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <img src="{{ asset('images/home/content_3.jpg') }}" class="img-fluid" alt="Products Image">
            </div>
