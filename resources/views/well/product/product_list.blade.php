                                    ...
                                    <div class="card product-card h-100">
                                        ...
                                        <div class="card-body d-flex flex-column custom-padding">
                                            ...
                                            <div class="mt-5 product-list-card-add" style="display: flex">
                                                <p class="card-text mt-auto" style="margin:auto 0">
                                                ...
                                                <div style="display: flex; justify-content: center; align-items: center; margin-bottom: -10px">
                                                    <form action="{{ route('CartItemStore') }}" method="POST"
                                                        ...
                                                        <button type="submit"
                                                                style="background-color: #00AA79; border: none; border-radius: 50%; width: 44px; height: 44px; display: flex; align-items: center; justify-content: center; box-shadow: 0px 4px 8px rgba(0, 170, 121, 0.3);">

                                                            <svg xmlns="http://www.w3.org/2000/svg" width="20"
                                                                 height="20" fill="white" stroke="white"
                                                                 stroke-width="1" class="bi bi-plus"
                                                                 viewBox="0 0 16 16">
