...
Route::controller(ContactQueryController::class)->group(function () {
    ...
    Route::patch('/queries/{id}/status', 'updateStatus')->name(
      'admin.queries.updateStatus'
    );
    ...
    Route::post('/queries/{id}/follow-up', 'saveFollowUpNotes')->name(
      'admin.queries.saveFollowUpNotes'
    );
});
