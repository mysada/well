@extends('layouts.app')
@vite(['resources/sass/checkout.scss', 'resources/js/checkout.js'])
        ...
        <div class="flex-fill">
            ...
            <div class="form-section">
                ...
                <form id="payment-form">
                    ...
                    <div>
                        <label>
                            <input type="radio" name="payment-method" value="other"> Other Payment Methods
                        </label>
                    </div>
                </form>
            </div>
            ...
            <div class="checkout-section form-section">
                ...
                <label for="same-address">Shipping address is same as billing address</label>
            </div>

            <!-- Shipping Address -->
            <div id="shipping-address-section" class="form-section">
            ...
            <a href="#" class="btn btn-proceed-to-checkout mt-4">Proceed to Checkout</a>
        </div>
