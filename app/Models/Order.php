...
class Order extends Model
{
     ...
     *
     * This method defines a one-to-many relationship between the Order and OrderDetail models.
     * It retrieves all the order details associated with a particular order.
     */
